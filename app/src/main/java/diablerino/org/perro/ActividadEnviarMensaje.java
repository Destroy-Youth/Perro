...
import android.os.Build;    //MAnejo de OS de android000
//import android.support.annotation.RequiresApi;
import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;   //Verificacion de version
...
public class ActividadEnviarMensaje extends AppCompatActivity {
  ...
  //  @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
   ...
   // @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1) Versiones posteriores
